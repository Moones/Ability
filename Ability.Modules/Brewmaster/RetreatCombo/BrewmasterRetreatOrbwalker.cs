// <copyright file="BrewmasterRetreatOrbwalker.cs" company="EnsageSharp">
...
// </copyright>
namespace Ability.Brewmaster.RetreatCombo
{
    ...
    public class BrewmasterRetreatOrbwalker : BrewmasterOrbwalker
    {
        #region Constructors and Destructors

        public BrewmasterRetreatOrbwalker(IAbilityUnit unit)
            : base(unit)
        {
        }
