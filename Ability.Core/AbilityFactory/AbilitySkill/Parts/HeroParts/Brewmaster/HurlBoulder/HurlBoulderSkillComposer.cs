// <copyright file="HurlBoulderSkillComposer.cs" company="EnsageSharp">
...
// </copyright>
namespace Ability.Core.AbilityFactory.AbilitySkill.Parts.HeroParts.Brewmaster.HurlBoulder
{
    ...
    [AbilitySkillMetadata((uint)AbilityId.brewmaster_earth_hurl_boulder)]
    internal class HurlBoulderSkillComposer : DefaultSkillComposer
    {
